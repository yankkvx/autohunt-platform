...
class AdFilter(django_filters.FilterSet):
    ...
    number_of_seats_min = django_filters.NumberFilter(
        field_name='number_of_seats', lookup_expr='gte')
    number_of_seats_max = django_filters.NumberFilter(
        field_name='number_of_seats', lookup_expr='lte')
    number_of_doors_min = django_filters.NumberFilter(
        field_name='number_of_doors', lookup_expr='gte')
    number_of_doors_max = django_filters.NumberFilter(
        field_name='number_of_doors', lookup_expr='lte')
    owner_count_min = django_filters.NumberFilter(
        field_name='owner_count', lookup_expr='gte')
    owner_count_max = django_filters.NumberFilter(
        field_name='owner_count', lookup_expr='lte')
    ...
    class Meta:
        ...
        fields = [
            ...
            'condition', 'price_min', 'price_max', 'user',
        ]
